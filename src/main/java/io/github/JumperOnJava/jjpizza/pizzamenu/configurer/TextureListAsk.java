...
public class TextureListAsk extends AskScreen<Identifier> {
    ...
    private Identifier selectedTexture = Identifier.of("minecraft","empty");
    ...
    protected void init() {
        ...
        selectedTextureWidget = new TextureWidget(Identifier.of(Identifier.DEFAULT_NAMESPACE,""),gap/2,height-40-gap/2,40,40);
    ...
    private void filterList(String s) {
        ...
        for(var key : textures){
            ...
            var button = new ButtonWidget.Builder(Text.literal(id),b->{
                this.selectedTexture = Identifier.of(Identifier.DEFAULT_NAMESPACE,b.getMessage().getString());
